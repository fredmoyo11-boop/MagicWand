...
max_rounds = 3
self_ip = "192.168.8.102"  # add the intranet-public IP here, e.g., 192.168.1.1
...
def castspell():
    ...
    print("[Received Spell] Team: " + teamname + ", Slot: " + slot +
          ", Spell name: " + spell_name + ", Spell class: " + spell_class)
